...
RSpec.describe CalendarEventsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all calendar_events as @calendar_events" do
  ...
  describe "GET #show" do
    it "assigns the requested calendar_event as @calendar_event" do
      calendar_event = CalendarEvent.create! valid_attributes
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the calendar_event as @calendar_event" do
        calendar_event = CalendarEvent.create! valid_attributes
